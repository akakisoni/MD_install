...
sudo apt-get update
echo "\033[1;32m По Идее Должена Начаться Установка UNZIP \033[0m"
echo "\033[1;32m По Идее Должен Установиться UNZIP \033[0m"
sudo apt-get install unzip -y
echo "\033[1;32m По Идее Должна Закончиться Установка UNZIP \033[0m"
